...
// Application is designed for production Flink cluster deployment only
// Local execution not supported - use shadowJar for deployment
...
dependencies {
    ...
    // External connectors – provided by Flink cluster in production
...
tasks.withType<com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar> {
    ...
    archiveFileName.set("zm-scpro-disa-orders-ack-pipeline-all.jar")
    mergeServiceFiles()
    minimize {
        // Keep Jackson fully
