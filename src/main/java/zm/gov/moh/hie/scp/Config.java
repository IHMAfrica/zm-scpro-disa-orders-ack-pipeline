...
public class Config {
    ...
    private Config(
        ...
        this.kafkaSaslPassword = kafkaSaslPasswordIfNull(kafkaSaslPassword);
        this.jdbcUrl = jdbcUrl;
        this.jdbcUser = jdbcUser;
        this.jdbcPassword = jdbcPassword;
    }

    private String kafkaSaslPasswordIfNull(String value) {
    ...
    public static Config fromEnvAndArgs(String[] args) {
        ...
        // 1) defaults for orders ack pipeline
        params.put("kafka.bootstrap.servers", "154.120.216.119:9093,102.23.120.153:9093,102.23.123.251:9093");
        params.put("kafka.topic", "lab-orders-ack");
        params.put("kafka.group.id", "flink-scpro-disa-orders-ack-consumer");
